...
<title>Sửa thông tin thương hiệu</title>
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Sửa thương hiệu</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title">Sửa thương hiệu</h2>
                        <h4 class="text-danger mb-4">${editBrandError}</h4>
                        <div class="form-validation">
                            <form id="idformeditbrand" class="form-valide" action="#" method="post">
...
<script>
    $("#idformeditbrand").submit(function (event) {
        ...
        if (!checkNameBrand(name) || !checkPhoneNumber(phonenumber) || !checkEmail(email) || !checkAddress(address)) {
            ...
            swal({
                title: 'Cảnh báo!',
                text: 'Đồng ý sửa thông tin thương hiệu?',
                type: "warning",
                showCancelButton: !0,
